<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="myOrders.aspx.cs" Inherits="ShopProject.Back.commen.myOrders" %>
					...
					<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="详情信息">
                              <ItemTemplate>
                                  <a href="myOrdersInfo.aspx?id=<%# Eval("orid") %>" >详细信息</a>
