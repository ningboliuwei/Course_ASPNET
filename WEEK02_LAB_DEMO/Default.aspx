<%@ page language="C#" autoeventwireup="true" inherits="_Default, App_Web_hcdfsa9z" %>
...
<body>
    ...
    <div>
        ...
        <p>个人简介：<br/><asp:TextBox ID="txtResume" runat="server" TextMode="MultiLine" Height="100px" Width="400px"/></p>
