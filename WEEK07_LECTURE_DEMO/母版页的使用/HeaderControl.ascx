<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HeaderControl.ascx.cs" Inherits="母版页的使用.HeaderControl" %>
<div style="border: solid 1px #B5C7DE">
    <div style="text-align: center;">
        <table style="width: 100%;">
            <tr>
                <td style="width: 265px;">
                    <img alt="" src="images/logo.jpg" style="width: 265px; height: 77px" />
                </td>
                <td style="width: 478px;">
                    <img alt="" src="images/banner.jpg" style="width: 478px; height: 84px" />
                </td>
