<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main.aspx.cs" Inherits="ShopProject.Back.admin.main" %>
<%@ Register TagPrefix="uc1" TagName="left" Src="~/Back/用户控件/left.ascx" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <div style="width: 230px;float:left;height:100%">
        <uc1:left runat="server" ID="left_UserGuan"/>
     </div>
