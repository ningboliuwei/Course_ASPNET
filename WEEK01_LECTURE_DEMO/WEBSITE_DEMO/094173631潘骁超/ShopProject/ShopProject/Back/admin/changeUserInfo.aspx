<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="changeUserInfo.aspx.cs" Inherits="ShopProject.Back.admin.changeUserInfo" %>
				     ...
				     <table width="300px">
				        ...
				        <td>
                            ...
                            <asp:Button ID="Button2" runat="server" CssClass="input1" Text="显示日期" 
                                onclick="Button2_Click" />&nbsp;&nbsp;<span class="red">*</span><asp:Calendar 
				        ...
				        <td>
                            <asp:TextBox ID="idcards" runat="server"></asp:TextBox>
				        </td>
				        </tr> 
				        ...
				        <td colspan="2" align="center">
                            <asp:Button ID="Button1" CssClass="input" runat="server" Text="修改信息" 
                                onclick="Button1_Click" />&nbsp;&nbsp;&nbsp;<asp:Button ID="Button3" 
                                CssClass="input" runat="server" Text="返回" onclick="Button3_Click" />
				        </td>
				        </tr>
				     </table>
