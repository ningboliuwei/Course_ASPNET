<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addSort.aspx.cs" Inherits="ShopProject.Back.admin.addSort" %>
				...
				<div class="content-content">
				     <table width="350px">
				        ...
				        <td colspan="2" align="center">
                            <asp:Button ID="Button1" CssClass="input" runat="server" Text="添加" onclick="Button1_Click" 
                                 />
				        </td>
				        </tr>
				     </table>
