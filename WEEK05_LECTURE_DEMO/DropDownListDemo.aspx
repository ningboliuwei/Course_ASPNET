<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DropDownListDemo.aspx.cs"
    Inherits="WEEK05_LECTURE_DEMO_DropDownListDemo" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="改变选中项" />
        <br />
        <br />
        Text属性：<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
        <br />
